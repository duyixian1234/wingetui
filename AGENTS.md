...
4. **winget 交互**：一律 subprocess 调用 winget CLI，查询类解析**文本表格**输出（v1.29.280 不支持 `--output json`，契约见 [specs/bugfix-query-output.md](specs/bugfix-query-output.md)），变更类非交互执行，见 [ADR-0002](docs/adr/0002-winget-subprocess.md)。
